  ...
  <div className="MagicContainter" id='background'>
    ...
    <div className='MagicGallery'>
      ...
      <figure id="MagicGallery-Item6" data-aos='fade-left'>
        ...
        <p className="text">Welcome to Adventureland this park represents the mystery of exploring foreign lands. It is themed to resemble the remote jungles in Africa, Asia, the Middle East, South America and the South Pacific, resembling a Caribbean town square. It contains classic attractions such as Pirates of the Caribbean, Jungle Cruise, Walt Disney's Enchanted Tiki Room, Swiss Family Treehouse, and The Magic Carpets of Aladdin.</p>
      </figure>
      ...
      <figure id="MagicGallery-Item8" data-aos='fade-right'>
        ...
        <p className="text">In Frontierland guests can relive the American Old West, from the romanticized cowboys and Native Americans, to exploring the mysteries of the Rivers of America. It contains classic attractions such as Big Thunder Mountain Railroad, Splash Mountain, and the Country Bear Jamboree. So put on your cowboy hat, shine your boots, and saddle up, because you are in Frontierland</p>
      </figure>
      ...
      <figure id="MagicGallery-Item10" data-aos='fade-left'>
        ...
        <p className="text">Main Street is lined with shops selling merchandise and food. The decor is early-20th century small-town America, inspired by Walt Disney's childhood and the film Lady and the Tramp.</p>
      </figure>
    </div>
  </div>
</div>
