      ...
      <div className="MagicContainter" id='background'>
        ...
        <div className='MagicGallery'>
          ...
          <figure id="MagicGallery-Item4" data-aos='fade-right'>
            <h1 className='center-Magic'>Fantasy Land</h1>
            <p className="text-Magic">Welcome to Fantasyland a carnival based theme park. Step into your own fantasy, be who you want, and make your dreams a reality. Fantasyland is dedicated to the young at heart and to those who believe that when you wish upon a star, your dreams come true. Attractions include It's a Small World, Peter Pan's Flight, and Mickey's PhilharMagic . </p>
          </figure>
          ...
          <figure id="MagicGallery-Item8" data-aos='fade-right'>
            <h1 className='center-Magic'>Frontier Land</h1>
            <p className="text-Magic">In Frontierland guests can relive the American Old West. It contains classic attractions such as Big Thunder Mountain Railroad, Splash Mountain, and the Country Bear Jamboree. So put on your cowboy hat, shine your boots, and saddle up, because you are in Frontier Land</p>
          </figure>
          ...
          <figure id="MagicGallery-Item10" data-aos='fade-left'>
            <h1 className='center-Magic'>Main Street</h1>
            <p className="text-Magic">Main Street is lined with shops selling merchandise and food. The decor is early-20th century small-town America, inspired by Walt Disney's childhood and the film Lady and the Tramp.</p>
          </figure>
        </div>
      </div>
    </div>
