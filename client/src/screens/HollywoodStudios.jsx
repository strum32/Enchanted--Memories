  ...
  <div className="HollyContainter" id='background'>
    ...
    <div className='HollyGallery'>
      ...
      <figure id="HollyGallery-Item2" data-aos="fade-left">
        <h1 className='center-Holly'>Toy Story Land</h1> 
        <p className='text-Holly'>Toy Story Land is inspired by Pixar's Toy Story series. Come join Andy and play with his toys for the day. Enjoy reliving your favorite movies and ride our new attractions. The attractions include Toy Story Mania, Slinky Dog Dash, and Alien Swirling Saucers. </p>
      </figure>
      ...
      <figure id="HollyGallery-Item4" data-aos="fade-right">
        <h1 className='center-Holly'>Star Wars: Galaxy's Edge</h1> 
        <p className='text-Holly'>Star Wars: Galaxy's Edge is set within the Star Wars universe, at the Black Spire Outpost village on the remote frontier planet of Batuu. Build a light saber, become a Jedi and defend your planet against the First Order. Attractions include Star Wars: Rise of the Resistance, and Millennium Falcon: Smugglers Run.</p>
      </figure>
